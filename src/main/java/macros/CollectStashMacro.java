...
public class CollectStashMacro implements Macro {
    ...
    private void performShiftClick(int slotIndex, int mouseButton, int ShiftButton, String actionDescription) {
        ...
        if (mc.currentScreen instanceof GuiContainer && slotIndex >= 0) {
            ...
            Chat.formatedChatMessage("Attempting to " + actionDescription + " slot: " + slotIndex);
            ...
            Chat.formatedChatMessage(actionDescription + " executed!");
        } else {
            Chat.formatedChatMessage("Cannot click: GUI not open or button index invalid (" + slotIndex + ")");
        }
    }
    ...
    public void onTick(TickEvent.PlayerTickEvent event) {
        ...
        if (tickcounter > 0) {
            if (tickcounter % 20 == 0) { // Jede Sekunde ausgeben
                Chat.formatedChatMessage("Noch " + (tickcounter / 20) + " Sekunden zu warten");
            }
            tickcounter--;
            return;
        }
        ...
        switch (currentState) {
            ...
            case GET_ITEMS:
                ...
                if (!itemsCollected) {
                    Chat.formatedChatMessage("Sammle Items zum ersten Mal...");
                    itemList.clear();
                    betterFormOfItemList.clear();
                    ...
                    for (int i = 0; i < containerSize + 2; i++) {
                        ...
                        if (stack != null && stack.getItem() != null) {
                            ...
                            if (cleanDisplayName != null && cleanDisplayName.contains("Insert Into Sacks")) {
                                indexOfButton = i;
                                Chat.formatedChatMessage("Found 'Insert Into Sacks' at slot: " + i);
                                continue;
                            }
                            ...
                            if (registryName != null && !registryName.equals(" ")) {
                                ...
                                Chat.formatedChatMessage(cleanDisplayName + " at spot: " + i);
                                ...
                                Chat.formatedChatMessage("Item added : " + cleanDisplayName);
                            }
                        }
                    }
                    itemsCollected = true;
                    Chat.formatedChatMessage("Insgesamt " + betterFormOfItemList.size() + " Items gefunden!");
                } else {
                ...
                if (indexOfButton >= 0) {
                    Chat.formatedChatMessage("Button found at index: " + indexOfButton);
                } else {
                    Chat.formatedChatMessage("Insert Into Sacks button not found!");
                }
            ...
            case FILL_INTO_SACKS:
                if (mc.currentScreen instanceof GuiContainer && indexOfButton >= 0) {
                    GuiContainer gui = (GuiContainer) mc.currentScreen;
                    Chat.formatedChatMessage("Attempting to click slot: " + indexOfButton);
                    ...
                    Chat.formatedChatMessage("Click executed!");
                } else {
                    Chat.formatedChatMessage("Cannot click: GUI not open or button index invalid (" + indexOfButton + ")");
                }
            ...
            case CLOSE_MENU:
                ...
                if (betterFormOfItemList.size() > 0) {
                    ...
                    Chat.formatedChatMessage("Keine Items zum Verarbeiten gefunden!");
                    currentState = MacroState.DISABLED;
                }
            ...
            case OPEN_SUPER_CRAFT:
                ...
                if (atItemIndex >= betterFormOfItemList.size()) {
                    Chat.formatedChatMessage("Alle Items wurden verarbeitet! Starte neue Runde...");
                ...
                Chat.formatedChatMessage("Verarbeite Item " + (atItemIndex + 1) + " von " + betterFormOfItemList.size() + ": " + betterFormOfItemList.get(atItemIndex));
            ...
            case SELECT_ITEM:
                ...
                for (int i = 0; i < containerSize; i++) {
                    ...
                    if (stack != null && stack.getItem() != null) {
                        ...
                        if(cleanDisplayName.equals(betterFormOfItemList.get(atItemIndex))) {
                            indexOfButton = i;
                            Chat.formatedChatMessage("Found Item: " + cleanDisplayName);
                            break;
                        }
                    }
                }
                ...
                if (indexOfButton >= 0) {
                    Chat.formatedChatMessage("Item found at index: " + indexOfButton);
                    ...
                    if (mc.currentScreen instanceof GuiContainer) {
                        ...
                        Chat.formatedChatMessage("Item selected!");
                    }
                } else {
                    Chat.formatedChatMessage("Item not found: " + betterFormOfItemList.get(atItemIndex));
                }
            ...
            case CLICK_SUPERCRAFT:
                ...
                for (int i = 0; i < containerSize; i++) {
                    ...
                    if (stack != null && stack.getItem() != null) {
                        ...
                        if(cleanDisplayName.equals("supercraft")) {
                            indexOfButton = i;
                            Chat.formatedChatMessage("Found Supercraft button");
                            break;
                        }
                    }
                }
                ...
                if (indexOfButton >= 0) {
                    Chat.formatedChatMessage("Supercraft button found at index: " + indexOfButton);
                    // Verwende die vereinfachte Methode für Shift+Rechtsklick
                    performShiftClick(indexOfButton, 1, 1, "Shift+Right-click");
                } else {
                    Chat.formatedChatMessage("Supercraft button not found!");
                }

                Chat.formatedChatMessage("Menü geschlossen nach Supercraft.");
            ...
            case AFTER_SUPERCRAFT:
                ...
                // Prüfen ob noch Items zu verarbeiten sind
                if (atItemIndex < betterFormOfItemList.size()) {
                    Chat.formatedChatMessage("Nächstes Item wird verarbeitet: " + betterFormOfItemList.get(atItemIndex));
                    currentState = MacroState.OPEN_SUPER_CRAFT;
                } else {
                    Chat.formatedChatMessage("Alle Items dieser Runde wurden verarbeitet! Starte neue Runde...");
                    // Zurück zum Anfang für die nächste Runde
                    atItemIndex = 0;
                    itemsCollected = false; // Items müssen neu gesammelt werden
                    currentState = MacroState.OPEN_STASH;
